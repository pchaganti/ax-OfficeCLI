...
officecli add "$DOCX" /body --type paragraph \
    --prop "text=Numbering & List Showcase" --prop alignment=center \
    --prop bold=true --prop size=20

officecli add "$DOCX" /body --type paragraph \
    --prop "text=Generated by officecli — covers abstractNum, num, and style-borne numPr" \
    --prop alignment=center --prop italic=true --prop color=666666
...
officecli add "$DOCX" /body --type paragraph \
    ...
    --prop italic=true --prop color=666666 --prop alignment=center
